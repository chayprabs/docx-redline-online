...
export default function DocxRedlinePage() {
  return (
    <PlaygroundShell
      ...
      compareStatusOutputLabel="Queue"
      compareStatusOriginalIdleValue="Original needed"
      compareStatusRevisedIdleValue="Revised needed"
      compareStatusOutputReadyValue="Queue ready"
      compareStatusOutputIdleValue="Queue pending"
      compareStatusOutputLoadingValue="Building queue"
