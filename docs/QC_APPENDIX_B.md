...
- `.github/workflows/verify-hosted.yml` now supports push-to-`main`, nightly scheduled, and workflow-dispatch hosted verification with the default public URLs wired in.
